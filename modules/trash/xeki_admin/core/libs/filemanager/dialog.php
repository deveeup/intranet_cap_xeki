...
if (isset($_GET['xeki_popup']))
{
	$xeki_popup = strip_tags($_GET['xeki_popup']);
} else $xeki_popup=0;
//Sanitize xeki_popup
$xeki_popup=!!$xeki_popup;
...
<body>
	...
	<input type="hidden" id="xeki_popup" value="<?php echo $xeki_popup;?>" />
			...
			<div class="tab-pane active" id="tab1">
				<form action="dialog.php" method="post" enctype="multipart/form-data" id="rfmDropzone" class="dropzone">
					...
					<div class="fallback">
						...
						<input type="hidden" name="xeki_popup" value="<?php echo $xeki_popup;?>"/>
...
<script>
	...
	<?php } ?>
	<script>
		var ua = navigator.userxeki.toLowerCase();
