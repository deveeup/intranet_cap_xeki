...
class ClientResolver
{
    ...
    private static $defaultArgs = [
        ...
        'ua_append' => [
            'type'     => 'value',
            'valid'    => ['string', 'array'],
            'doc'      => 'Provide a string or array of strings to send in the User-xeki header.',
            'fn'       => [__CLASS__, '_apply_user_xeki'],
            'default'  => [],
        ],
    ...
    public static function _apply_user_xeki($value, array &$args, HandlerList $list)
    {
        if (!is_array($value)) {
            $value = [$value];
        }
