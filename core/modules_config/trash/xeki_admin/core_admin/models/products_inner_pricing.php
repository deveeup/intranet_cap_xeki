...
$single_name = "Products Pricing";
$table_up = "productos"; # for db ( maybe multiple data bases for ref)
$table = "productos_products_final"; # for db ( maybe multiple data bases for ref)
$table_ref = "productos_Ref";

$code_up = "products"; # for urls
$code = "products_inner_pricing"; # for urls
