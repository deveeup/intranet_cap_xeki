...
$title = "Sedes Images";
$single_name = "Sedes Image";
$table_up = "sedes"; # for db ( maybe multiple data bases for ref)
$table = "sedes_covers"; # for db ( maybe multiple data bases for ref)
$table_ref = "sedes_Ref";

$code_up = "sedes"; # for urls
$code = "sedes_inner_images"; # for urls
