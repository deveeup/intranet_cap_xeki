...
$table = "slider_presidencial"; # for db ( maybe multiple data bases for ref)
$code = "slider_presidencial"; # for urls

$inner_code = "slider_presidencial_text_inner"; # for urls
...
$html_inners_edit = <<<HTML
    ...
    <div id_form="form_edit_list_{$inner_code}" id_item="{$id_item}" class="admin-btn"><i class="fa fa-pencil" aria-hidden="true"></i> Textos</div>
...
//    d($_GET);
    ...
    array_push($columns, array("db" => "texto", "dt" => count($columns)));
