...
$title = "Slide Presidencial";
$single_name = "Slide Presidencial";
$table_up = "slider_presidencial"; # for db ( maybe multiple data bases for ref)
$table = "slider_presidencial_items_list"; # for db ( maybe multiple data bases for ref)
$table_ref = "slider_presidencial_Ref";

$code_up = "slider_presidencial"; # for urls
$code = "slider_presidencial_text_inner"; # for urls


$html_inners_edit = <<<HTML
    <div id_form="form_edit_{$code_up}"   id_item="{$id_item}" class="admin-btn"><i class="fa fa-pencil" aria-hidden="true"></i> Editar</div>
    <div id_form="form_edit_list_{$code}" id_item="{$id_item}" class="admin-btn"><i class="fa fa-pencil" aria-hidden="true"></i> Textos</div>
    <div id_form="form_delete_{$code_up}" id_item="{$id_item}" class="admin-btn"><i class="fa fa-trash-o" aria-hidden="true"></i> Delete </div> 
HTML;
    ...
    foreach ($res as $inner_item){
        $text.="
         <tr>
              ...
              <td>{$inner_item['item']}</td>
              <td>{$inner_item['order_list']}</td>
              <td>
