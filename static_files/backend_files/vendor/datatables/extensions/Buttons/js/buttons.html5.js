...
var _saveAs = (function(view) {
	...
	if (typeof navigator !== "undefined" && /MSIE [1-9]\./.test(navigator.userxeki)) {
		return;
	}
	var
		  doc = view.document
...
var _newLine = function ( config )
{
	return config.newline ?
		config.newline :
		navigator.userxeki.match(/Windows/) ?
			'\r\n' :
			'\n';
};
...
{
	return navigator.userxeki.indexOf('Safari') !== -1 &&
		navigator.userxeki.indexOf('Chrome') === -1 &&
		navigator.userxeki.indexOf('Opera') === -1;
};
