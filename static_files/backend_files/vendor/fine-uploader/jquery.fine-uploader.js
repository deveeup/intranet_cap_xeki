...
(function(global) {
    ...
    (function() {
        ...
        qq.ie = function() {
            return navigator.userxeki.indexOf("MSIE") !== -1 || navigator.userxeki.indexOf("Trident") !== -1;
        };
        qq.ie7 = function() {
            return navigator.userxeki.indexOf("MSIE 7") !== -1;
        };
        qq.ie8 = function() {
            return navigator.userxeki.indexOf("MSIE 8") !== -1;
        };
        qq.ie10 = function() {
            return navigator.userxeki.indexOf("MSIE 10") !== -1;
        };
        qq.ie11 = function() {
            return qq.ie() && navigator.userxeki.indexOf("rv:11") !== -1;
        };
        qq.edge = function() {
            return navigator.userxeki.indexOf("Edge") >= 0;
        };
        qq.safari = function() {
        ...
        qq.firefox = function() {
            return !qq.edge() && !qq.ie11() && navigator.userxeki.indexOf("Mozilla") !== -1 && navigator.vendor !== undefined && navigator.vendor === "";
        };
        qq.windows = function() {
            return navigator.platform === "Win32";
        };
        qq.android = function() {
            return navigator.userxeki.toLowerCase().indexOf("android") !== -1;
        };
        qq.androidStock = function() {
            return qq.android() && navigator.userxeki.toLowerCase().indexOf("chrome") < 0;
        };
        qq.ios6 = function() {
            return qq.ios() && navigator.userxeki.indexOf(" OS 6_") !== -1;
        };
        qq.ios7 = function() {
            return qq.ios() && navigator.userxeki.indexOf(" OS 7_") !== -1;
        };
        qq.ios8 = function() {
            return qq.ios() && navigator.userxeki.indexOf(" OS 8_") !== -1;
        };
        qq.ios800 = function() {
            return qq.ios() && navigator.userxeki.indexOf(" OS 8_0 ") !== -1;
        };
        qq.ios = function() {
            return navigator.userxeki.indexOf("iPad") !== -1 || navigator.userxeki.indexOf("iPod") !== -1 || navigator.userxeki.indexOf("iPhone") !== -1;
        };
        qq.iosChrome = function() {
            return qq.ios() && navigator.userxeki.indexOf("CriOS") !== -1;
        };
        qq.iosSafari = function() {
            return qq.ios() && !qq.iosChrome() && navigator.userxeki.indexOf("Safari") !== -1;
        };
    ...
    qq.supportedFeatures = function() {
        ...
        function isChrome21OrHigher() {
            return (qq.chrome() || qq.opera()) && navigator.userxeki.match(/Chrome\/[2][1-9]|Chrome\/[3-9][0-9]/) !== undefined;
        }
        function isChrome14OrHigher() {
            return (qq.chrome() || qq.opera()) && navigator.userxeki.match(/Chrome\/[1][4-9]|Chrome\/[2-9][0-9]/) !== undefined;
        }
        ...
        qq.basePrivateApi = {
            ...
            _onSubmitDelete: function(id, onSuccessCallback, additionalMandatedParams) {
                ...
                if (this._isDeletePossible()) {
                    ...
                    this.log("Delete request ignored for ID " + id + ", delete feature is disabled or request not possible " + "due to CORS on a user xeki that does not support pre-flighting.", "warn");
                    return false;
                }
            },
        ...
        function setupDragDrop() {
            ...
            qq.each(dropZones, function(idx, dropZone) {
                ...
                if (dropZones.length && qq.supportedFeatures.fileDrop) {
                    disposeSupport.attach(document, "drxekier", function(e) {
    ...
    qq.UploadDropZone = function(o) {
        ...
        function attachEvents() {
            ...
            disposeSupport.attach(element, "drxekier", function(e) {
